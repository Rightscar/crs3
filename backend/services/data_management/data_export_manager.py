...
@dataclass
class DataExportManagerConfig:
    """Configuration for DataExportManager"""
    enabled: bool = True
...
class DataExportManager:
    ...
    def __init__(self, config: Optional[DataExportManagerConfig] = None):
        self.config = config or DataExportManagerConfig()
