...
@dataclass
class BackupRestoreManagerConfig:
    """Configuration for BackupRestoreManager"""
    enabled: bool = True
...
class BackupRestoreManager:
    ...
    def __init__(self, config: Optional[BackupRestoreManagerConfig] = None):
        self.config = config or BackupRestoreManagerConfig()
