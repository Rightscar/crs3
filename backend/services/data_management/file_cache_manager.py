...
@dataclass
class FileCacheManagerConfig:
    """Configuration for FileCacheManager"""
    enabled: bool = True
...
class FileCacheManager:
    ...
    def __init__(self, config: Optional[FileCacheManagerConfig] = None):
        self.config = config or FileCacheManagerConfig()
