...
@dataclass
class MobileOptimizerConfig:
    """Configuration for MobileOptimizer"""
    enabled: bool = True
...
class MobileOptimizer:
    ...
    def __init__(self, config: Optional[MobileOptimizerConfig] = None):
        self.config = config or MobileOptimizerConfig()
