...
@dataclass
class ContextMenuHandlerConfig:
    """Configuration for ContextMenuHandler"""
    enabled: bool = True
...
class ContextMenuHandler:
    ...
    def __init__(self, config: Optional[ContextMenuHandlerConfig] = None):
        self.config = config or ContextMenuHandlerConfig()
