...
@dataclass
class AccessibilityHandlerConfig:
    """Configuration for AccessibilityHandler"""
    enabled: bool = True
...
class AccessibilityHandler:
    ...
    def __init__(self, config: Optional[AccessibilityHandlerConfig] = None):
        self.config = config or AccessibilityHandlerConfig()
