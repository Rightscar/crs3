...
@dataclass
class TooltipManagerConfig:
    """Configuration for TooltipManager"""
    enabled: bool = True
...
class TooltipManager:
    ...
    def __init__(self, config: Optional[TooltipManagerConfig] = None):
        self.config = config or TooltipManagerConfig()
