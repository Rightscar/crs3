...
@dataclass
class DragDropHandlerConfig:
    """Configuration for DragDropHandler"""
    enabled: bool = True
...
class DragDropHandler:
    ...
    def __init__(self, config: Optional[DragDropHandlerConfig] = None):
        self.config = config or DragDropHandlerConfig()
