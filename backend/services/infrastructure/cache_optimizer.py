...
class CacheOptimizerConfig:
    """Configuration for CacheOptimizer"""
    enabled: bool = True
...
class CacheOptimizer:
    ...
    def __init__(self, config: Optional[CacheOptimizerConfig] = None):
        self.config = config or CacheOptimizerConfig()
