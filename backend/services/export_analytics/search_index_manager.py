...
@dataclass
class SearchIndexManagerConfig:
...
class SearchIndexManager:
    ...
    def __init__(self, config: Optional[SearchIndexManagerConfig] = None):
        self.config = config or SearchIndexManagerConfig()
