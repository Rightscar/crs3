...
@dataclass
class JsonCsvExporterConfig:
    """Configuration for JsonCsvExporter"""
    enabled: bool = True
...
class JsonCsvExporter:
    ...
    def __init__(self, config: Optional[JsonCsvExporterConfig] = None):
        self.config = config or JsonCsvExporterConfig()
