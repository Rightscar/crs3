"""
SpacyThemeDiscovery Service
===========================

Theme discovery using spaCy NLP
...
@dataclass
class SpacyThemeDiscoveryConfig:
    """Configuration for SpacyThemeDiscovery"""
    enabled: bool = True
...
class SpacyThemeDiscovery:
    ...
    def __init__(self, config: Optional[SpacyThemeDiscoveryConfig] = None):
        self.config = config or SpacyThemeDiscoveryConfig()
