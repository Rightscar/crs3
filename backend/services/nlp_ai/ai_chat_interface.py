...
@dataclass
class AiChatInterfaceConfig:
    """Configuration for AiChatInterface"""
    enabled: bool = True
...
class AiChatInterface:
    ...
    def __init__(self, config: Optional[AiChatInterfaceConfig] = None):
        self.config = config or AiChatInterfaceConfig()
