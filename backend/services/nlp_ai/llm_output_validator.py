...
@dataclass
class LlmOutputValidatorConfig:
    """Configuration for LlmOutputValidator"""
    enabled: bool = True
...
class LlmOutputValidator:
    ...
    def __init__(self, config: Optional[LlmOutputValidatorConfig] = None):
        self.config = config or LlmOutputValidatorConfig()
